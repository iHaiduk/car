    ...
    xhrupload.defaults = {
      ...
      before: function(o, files) {
        ...
        for (_i = 0, _len = files.length; _i < _len; _i++) {
          val = files[_i];
          html = $('<div class="panel widget"> <div class="row row-table row-flush"> <div class="col-xs-2 bg-info text-center"> <em class="fa fa-file-text-o fa-2x"></em> </div> <div class="col-xs-9"> <div class="panel-body text-center"> <h4 class="mt0">' + val.name.substr(0, val.name.lastIndexOf('.')) + '</h4> <small> <em class="fa fa-inbox"></em>' + bytesToSize(parseInt(val.size)) + '<em class="fa fa-info"></em>' + val.type + '</small> </div> <div class="progress progress-striped progress-xs active"> <div role="progressbar" aria-valuenow="0" aria-valuemin="0" style="width: 0%" aria-valuemax="100" class="progress-bar progress-bar-info"> </div> </div> </div> <div class="col-xs-1 bg-inverse text-center"> <em class="fa fa-minus"></em> </div> </div> </div>');
