...
(function() {
  var clearForm, currentInfo, globalGetreloadModels, infoModels, infoObject, interval_send_i, interval_send_info, interval_send_info_k, nospace, reloadModels, returnName, sendInfo, setInfo;
  ...
  sendInfo = function() {
    ...
    interval_send_info = setTimeout(function() {
      ...
      $.post("/set/param", info_send, function() {
        setTimeout(function() {
          return $(document).find("#carspinner").css("opacity", 0);
        }, 500);
      });
    }, 750);
  };
